...
import { About, CartPage, CheckoutPage, LookBook, PasswordReset, ThankYouPage } from '@pages';
...
export const Routes: React.FC = () => (
    <Switch>
        ...
        <Route path={paths.aboutUrl} component={About}/>
        <Route path={paths.lookBookUrl} component={LookBook}/>
